...
public class AddressDTOBuilder implements Cloneable {
    ...
    protected boolean value$forSale$boolean; // mandatory construction parameter
    ...
    public AddressDTOBuilder withForSale(boolean aValue) {
        value$forSale$boolean = aValue;
        isSet$forSale$boolean = true;
        return self;
    }
    ...
    public AddressDTOBuilder copy(AddressDTO original) {
        withStreet(original.getStreet());
        withForSale(original.isForSale());
    ...
    public AddressDTO build() {
        AddressDTO result = new AddressDTO(value$name$java$lang$String, value$street$java$lang$String, value$city$java$lang$String, value$postCode$java$lang$String, value$forSale$boolean);
        return result;
    }
}