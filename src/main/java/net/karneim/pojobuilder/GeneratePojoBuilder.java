...
public @interface GeneratePojoBuilder {
    ...
    /**
     * Specifies the name of the generated builder. Any asterisk will be replaced with the pojo's simple name. Default
     * is "*Builder".
     * 
    ...
    /**
     * Specifies the package of the generated builder. Any asterisk will be replaced with the pojo's package. Default is
     * "*".
     * 
     ...
     * will copy all its fields into the builder. This allows it to easily change one or more fields of immutable
     * objects.
     */
