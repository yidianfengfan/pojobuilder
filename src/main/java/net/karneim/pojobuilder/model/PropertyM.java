...
import net.karneim.pojobuilder.TypeSet;
...
public class PropertyM {
	...
	public void addTo(TypeSet typeSet) {
		type.addTo(typeSet);
	...
	public String toString() {
		return "PropertyM [name=" + name + ", fieldname=" + fieldname
				+ ", type=" + type + ", setter=" + setter + ", getter="
				+ getter + ", accessible=" + accessible + ", parameterPos="
				+ parameterPos + ", readable=" + readable + ", writable="
				+ writable + ", setterExceptions=" + setterExceptions
